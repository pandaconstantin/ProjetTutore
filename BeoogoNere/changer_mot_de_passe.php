...
<head>
    ...
    <title>Stop Pollution System</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Changer Password</h1>
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-4 control-label" for="Old">Password Courant</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Password"> Nouveau Password</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm">Confirmer Password</label>
								<div class="col-sm-5">
